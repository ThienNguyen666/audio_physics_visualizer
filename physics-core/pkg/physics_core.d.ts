...
export class Universe {
    ...
    tick(bass: number, mid: number, treble: number, mouse_x: number, mouse_y: number, mouse_active: boolean): void;
}
...
export interface InitOutput {
    ...
    readonly universe_tick: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
